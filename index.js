...
function trimString(original, side) {
  if (side === "start") {
    ...
    return "Error: side should be either 'start', 'end' or 'both'"; // Якщо значення аргументу "side" не є ні "start", ні "end", ні "both", повертаємо повідомлення "Error: side should be either 'start', 'end' or 'both'"
  }
}
